...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { created_by_id: @battle.created_by_id, description: @battle.description, topic: @battle.topic }
    end
  ...
  test "should update battle" do
    patch :update, id: @battle, battle: { created_by_id: @battle.created_by_id, description: @battle.description, topic: @battle.topic }
    assert_redirected_to battle_path(assigns(:battle))
  end
